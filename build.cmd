...
msbuild.exe "mod_oauth2.vcxproj" /p:Configuration=Release /p:Platform="win32"
...
del target\mod_oauth2-3.2.0-win32-VS16.zip
...
powershell Compress-Archive -Path target\mod_oauth2\x86\Release\mod_oauth2.dll -Update -DestinationPath target\mod_oauth2-3.2.0-win32-VS16.zip